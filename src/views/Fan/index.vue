<template>
  <section class="bg-black min-h-screen">
    <div class="container py-10 mx-auto">
      <h1 class="text-white text-4xl">Fan favourites</h1>
      <div class="mt-7">
        <v-row>
          <v-col
            xs="6"
...
export default defineComponent({
  ...
  methods: {
    ...
    fetchData() {
      ...
      axios
        .get(
          `https://api.themoviedb.org/3/movie/top_rated?include_adult=true&include_null_first_air_dates=false&language=en-US&page=${this.page}&sort_by=popularity.desc`,
          {
            headers: {
