<template>
  <section class="bg-black py-5 min-h-[50vh]" ref="section">
    <div class="container mx-auto">
      <section-title title="Top 10 on IMDb this week" href="#" class="my-5" />
...
import type { ITop10Movies } from "../../../interfaces";
...
export default defineComponent({
  ...
  methods: {
    fetMovies() {
      ...
      axios
        .get(
          "https://api.themoviedb.org/3/movie/popular??include_adult=true&language=en-US&page=1",
          {
            headers: {
